...
namespace GTX.Common
{
    ...
    public static class ChatBotNavigationCatalog
    {
        private static readonly ChatBotNavigationDefinition[] Definitions =
        {
            ...
            Public("specials", "Specials", "Open the public Specials page.", "Specials", "List"),
            ...
            Authenticated("specials_management", "Specials Management", "Open internal Specials management.", "Specials", "Index"),
